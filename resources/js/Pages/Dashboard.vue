            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-4 text-xs">
                        <p>Approved<i class="fa-solid fa-circle-check"></i></p>
                        <p>
                            Pending approval<i
                ...
                >
                    ...
                    >
                        <tr>
                            ...
                            <th class="w-1/4 p-3 text-right">View</th>
                            <th class="w-1/5 p-3 text-right">Edit</th>
                            <th class="w-1/5 p-3 text-right">Delete</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr
                            ...
                            <td class="w-3/4 p-3 text-left">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h4 class="font-bold">
                                        {{ listing.title }}
                                        <i
                                            :class="`fa-solid fa-${listing.approved ? 'circle-check text-green-600' : 'circle-xmark text-red-500'}`"
                                        ></i>
                                    </h4>
                                </div>
                            </td>
